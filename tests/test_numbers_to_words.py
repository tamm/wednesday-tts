...
class TestNormalizeLargeNumbers:
    ...
    def test_plain_million(self):
        assert normalize_large_numbers("Found 1000000 results") == ("Found one million results")
    ...
    def test_formatted_million_commas(self):
        assert normalize_large_numbers("Revenue was 1,000,000") == ("Revenue was one million")

    def test_formatted_underscores(self):
        assert normalize_large_numbers("MAX = 1_000_000") == ("MAX = one million")
